...
# 
printf "${green}# Updating package lists and upgrading installed packages...${reset}\n"
apt update # Update package lists
printf "${green}# Packages upgraded.${reset}\n"
pkg upgrade -y # Upgrade installed packages
printf "${green}# Installing wget...${reset}\n"
pkg install wget -y # Install wget

# Welcome message
printf "${green}Welcome to NetHunter installer modified by @raviheima${reset}\n"
printf "${green}Twitter: https://twitter.com/raviheima${reset}\n"
printf "${green}GitHub Repo: https://github.com/raviheima${reset}\n\n"
green='\033[1;32m'
reset='\033[0m'
...
# Print the outro in bold and green with surrounding symbols
echo -e "${BOLD_GREEN}######################################"
echo -e "#                                    #"
echo -e "#    Thank you for using this script!    #"
echo -e "#    For more content, check out:    #"
echo -e "#    [Blog]   : https://amoledbytes.netlify.app  #"
echo -e "#    [YouTube]: https://youtube.com/@amoledbytes  #"
echo -e "#    [GitHub] : https://github.com/raviheima   #"
echo -e "#    [Twitter]: https://twitter.com/raviheima   #"
echo -e "#                                    #"
echo -e "######################################${NC}"